import { parseMessageTemplates, MessageTemplate } from '@ego/common'
...
!system 505 请选择要返回手卡的卡
!system 506 请选择要加入手卡的卡
...
!victory 0x17 「No.88　机关傀儡-命运狮子」特殊胜利
...
export const templateList = parseMessageTemplates(templateSrc)

export const templates: Record<
  'system' | 'counter' | 'setname' | 'victory',
...
for (const t of templateList) {
  templates[t.category].set(t.id, t)
}
