 ...
 * message type tags
 */
export type MessageTag = 'MSG_RETRY'
                       | 'MSG_HINT'
                       | 'MSG_WIN'
                       | 'MSG_WAITING'
                       | 'MSG_START'
...
export function parseFieldCardQueryResult(buffer: BufferLike): QueryCardChunk[] {
...
export function parseCardQueryResult(buffer: BufferLike): QueryCardChunk {
...
function parseMsgMove(buffer: BufferReader): MsgMove {
  ...
  { /* reading result (MsgMove) */
    ...
    { /* reading previous (Card) */
      ...
      previous.subsequence = buffer.nextU8();
    }
    ...
    { /* reading current (Card) */
      ...
      current.pos_or_subseq = buffer.nextU8();
    }
 ...
 */
export function parseMessage(from: BufferLike): Message[] {
 ...
 * question tags
 */
export type QuestionTag = 'MSG_SELECT_BATTLECMD'
                        | 'MSG_SELECT_IDLECMD'
                        | 'MSG_SELECT_EFFECTYN'
                        | 'MSG_SELECT_YESNO'
                        | 'MSG_SELECT_OPTION'
